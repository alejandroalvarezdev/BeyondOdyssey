...
//level3 
  ...
  shuffleCards() {
    let nivelParsed = parseInt(this.nivel);
    this.baraja_por_nivel = this.cards.filter(card=>{
      // console.log(card.level);
      // console.log(nivelParsed);
      
      // console.log(this.baraja_por_nivel);
      return card.level === nivelParsed
    }); 
    // console.log(this.baraja_por_nivel);
    ...
    this.shuffledCards = [...this.baraja_por_nivel];
